...
namespace TeHagoLaFila.Migrations
{
    ...
    [Migration("20180412011125_InitialMigration2.0")]
            ...
            modelBuilder.Entity("TeHagoLaFila.Models.Reservacion", b =>
                {
                    ...
                    b.Property<DateTime?>("EndAllTimes");

                    b.Property<DateTime?>("InitialReservationTime");

                    b.Property<DateTime?>("InitialServiceTime");
            ...
            modelBuilder.Entity("TeHagoLaFila.Models.Reservacion", b =>
                {
                    ...
                    b.HasOne("TeHagoLaFila.Models.Empleado", "Empleado")
                        .WithOne("Reservacion")
                        .HasForeignKey("TeHagoLaFila.Models.Reservacion", "EmpleadoID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
