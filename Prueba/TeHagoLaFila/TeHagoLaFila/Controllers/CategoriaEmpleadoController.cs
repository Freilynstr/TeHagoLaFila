...
namespace TeHagoLaFila.Controllers
{
    public class CategoriaEmpleadoController : Controller
    {
        ...
        public CategoriaEmpleadoController(TeHagoLaFilaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var categoriaEmpleado = await _context.CategoriaEmpleado.SingleOrDefaultAsync(m => m.CategoriaEmpleadoID == id);
            if (categoriaEmpleado == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.CategoriaEmpleado.Any(e => e.CategoriaEmpleadoID == id);
        }
    }
}
